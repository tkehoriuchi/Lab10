...
uint8_t redBufferEmpty = 0;
uint8_t blueBufferEmpty = 0;
...
void myTMR0ISR(void){
    ...
    static activeBuffer_t activeBuffersample = RED;
    static activeBuffer_t activeBufferpull = RED;
    if(fillBuffer) {
